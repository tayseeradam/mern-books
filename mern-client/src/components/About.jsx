...
const About = () => {
  return (
    <div className='mt-28 px-4 lg:px-24'>
      <h2 className='text-5xl font-bold text-center mb-8 text-teal-600 flex justify-center items-center'>
      ...
      <h3 className='text-3xl font-bold mt-8 text-teal-600 flex items-center'>
